...
parser.add_argument("--expert", type=str, default="egpo_utils/expert.npz")
...
expert_weights = osp.join(osp.dirname(__file__), args.expert)
...
if __name__ == "__main__":
    ...
    training_env = ExpertGuidedEnv(training_config)  # seperate with eval env
